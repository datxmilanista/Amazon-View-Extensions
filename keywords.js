export const keywordDatabase = {
  ...
  jp: {
    electronics: [
      ...
      'eufy セキュリティカメラ', 'apple pencil 第2世代', 'シャオミ スマートバンド', 'LG ウルトラワイドモニター'
    ],
    cosmetics: [
    ...
    home_goods: [
      ...
      '象印 ポット', 'アイリスオーヤマ 掃除機', 'バスマット 吸水速乾', '防災グッズ セット'
    ],
    toys: [
    ...
    hobby_culture: [
      '漫画全巻', 'ガンプラ rg', '鬼滅の刃 フィギュア', 'アイドルグッズ', 'コピックペンセット',
      'チェンソーマン blu-ray', 'スタジオジブリ グッズ', '呪術廻戦 同人誌', 'nintendo switch ソフト', 'ps5 ソフト',
      'スプラトゥーン3', 'ポケモン スカーレット', 'artbook', '画材', '万年筆 パイロット',
      'タミヤ ミニ四駆', '鉄道模型 nゲージ', '一眼レフカメラ', '御朱印帳', 'ウクレレ 初心者',
      'ポケモン 図鑑', 'デッサン用鉛筆セット', 'ジグソーパズル 1000ピース', 'スケッチブック A3'
    ],
    health_wellness: [
      'プロテイン ザバス', 'ビタミンc サプリ', 'マッサージガン', 'オーガニックシャンプー', '体重計',
      'フォームローラー', 'bcaa', 'マルチビタミン', '青汁', 'オムロン 血圧計',
      'めぐりズム', '入浴剤', 'ヨガマット', 'バランスボール', '電動歯ブラシ',
      'リポビタンd', '正露丸', '龍角散', 'サロンパス', 'バンドエイド'
    ],
    fashion_outdoor: [
      'nike スニーカー', 'the north face tシャツ', 'g-shock 腕時計', 'coleman テント', 'patagonia ジャケット',
      'new era キャップ', 'adidas スーパースター', 'uniqlo エアリズム', 'workman', 'snow peak',
      'keen サンダル', 'gramicci ショートパンツ', 'arcteryx a リュック', 'ray-ban サングラス', 'dr.martens',
      'porter バッグ', 'mont-bell', 'columbia ジャケット', 'ビルケンシュトック', 'champion パーカー',
      'ニューバランス スニーカー', 'アディダス トラックパンツ', 'mont-bell ダウン', 'アウトドア 帽子 メンズ'
    ],
    summer_seasonal: [
      '携帯扇風機', '日傘 折りたたみ', '浴衣 レディース', 'クールネックリング', '水着',
      '雪肌精 日焼け止め', 'ハンディファン', '虫除けスプレー', '甚平', 'ビーチサンダル',
      'ラッシュガード', 'うなぎ 国産', 'そうめん', 'かき氷機', 'ビアガーデン',
      '夏祭り', '花火 セット', '扇風機 dcモーター', 'クールタオル', '日焼け止め スプレー'
    ],
    mom_baby: [
      'パンパース おむつ', 'ベビーカー コンパクト', '抱っこ紐 おすすめ', 'ベビー モニター', 'アイクレオ 粉ミルク',
      '赤ちゃん 洗剤', 'ベビーバス', '新生児 肌着', 'ベビー布団セット', 'おしりふき ケース',
      'ベビー おしゃぶり', 'コンビ チャイルドシート', 'アンパンマン 歯ブラシ', '授乳クッション', 'ミルクウォーマー',
      // bổ sung thêm keyword mới
      'ベビーサークル', 'ベビーゲート', 'ベビーチェア', 'ベビー食器セット', 'ベビー枕', 'ベビーシャンプー', 'ベビーソープ'
    ]
  },
